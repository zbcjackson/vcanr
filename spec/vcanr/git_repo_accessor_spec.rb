  ...
  describe "Vcanr::GitRepoAccessor" do
    ...
    context "when repo has commits" do
      ...
      it "commits contains added changes" do
        ...
        expect(@repo.commits[0].deltas[0]).to have_attributes(old_file: "a.txt", new_file: "a.txt", status: :added, lines: 1)
        expect(@repo.commits[0].deltas[1]).to have_attributes(old_file: "b.txt", new_file: "b.txt", status: :added, lines: 1)
        expect(@repo.commits[0].deltas[2]).to have_attributes(old_file: "c.txt", new_file: "c.txt", status: :added, lines: 1)
      end
      it "commits contains modified changes" do
        ...
        expect(@repo.commits[1].deltas[0]).to have_attributes(old_file: "a.txt", new_file: "a.txt", status: :modified, lines: 1)
      end
      it "commits contains deleted changes" do
        ...
        expect(@repo.commits[2].deltas[0]).to have_attributes(old_file: "b.txt", new_file: "b.txt", status: :deleted, lines: 1)
      end
      it "commits contains renamed changes" do
        ...
        expect(@repo.commits[3].deltas[0]).to have_attributes(old_file: "c.txt", new_file: "d.txt", status: :renamed, lines: 0)
      end
      it "commits contains moved changes" do
        ...
        expect(@repo.commits[4].deltas[0]).to have_attributes(old_file: "d.txt", new_file: "d/d.txt", status: :renamed, lines: 1)
      end
    end
  end
end
